...
public class HttpHandler implements Runnable{
	...
	private static Log log = Log.getLog(HttpHandler.class);
	...
	////////////////////////////////////////////////////////////////////////////
	private HttpHandler(Socket socket, RequestHandler httpProcessor) {
	...
	public static void handleConnection( Socket socket, RequestHandler httpProcessor ) {
		...
		HttpHandler connectionHandler = new HttpHandler(socket,httpProcessor);
