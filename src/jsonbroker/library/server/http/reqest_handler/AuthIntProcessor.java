...
public class AuthIntProcessor implements RequestHandler {
	
	private static final Log log = Log.getLog(AuthIntProcessor.class);
	...
	private static DataEntity toDataEntity( Entity entity ) {
		...
		if (entity.getContentLength() > 64 * 1024) {
			...
			throw HttpErrorHelper.requestEntityTooLarge413FromOriginator(AuthIntProcessor.class);
		}
